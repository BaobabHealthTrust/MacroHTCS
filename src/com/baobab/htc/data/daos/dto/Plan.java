...
{
	/** 
	 * This attribute maps to the column planId in the Plan table.
	 */
	protected long planId;

	/** 
	 * This attribute maps to the column description in the Plan table.
	 */
	protected String description;

	/** 
	 * This attribute maps to the column dateCreated in the Plan table.
	 */
	protected Date dateCreated;

	/** 
	 * This attribute maps to the column createdBy in the Plan table.
	 */
	protected String createdBy;

	/** 
	 * This attribute maps to the column dateModified in the Plan table.
	 */
	protected Date dateModified;

	/** 
	 * This attribute maps to the column modifiedBy in the Plan table.
	 */
	protected String modifiedBy;

	/** 
	 * This attribute maps to the column status in the Plan table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof Plan)) {
			return false;
		}
		
		final Plan _cast = (Plan) _other;
	 ...
	 * @return PlanPk
	 */
	public PlanPk createPk()
	{
		return new PlanPk(planId);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.baobab.htc.data.daos.dto.Plan: " );
