...
{
	/** 
	 * This attribute maps to the column regionId in the Region table.
	 */
	protected long regionId;

	/** 
	 * This attribute maps to the column name in the Region table.
	 */
	protected String name;

	/** 
	 * This attribute maps to the column dateCreated in the Region table.
	 */
	protected Date dateCreated;

	/** 
	 * This attribute maps to the column createdBy in the Region table.
	 */
	protected String createdBy;

	/** 
	 * This attribute maps to the column dateModified in the Region table.
	 */
	protected Date dateModified;

	/** 
	 * This attribute maps to the column modifiedBy in the Region table.
	 */
	protected String modifiedBy;

	/** 
	 * This attribute maps to the column status in the Region table.
	 */
	...
	public String toString()
	{
		...
		ret.append( "com.baobab.htc.data.daos.dto.Region: " );
