...
/** 
 * This class represents the primary key of the Sequence table.
 */
public class SequencePk implements Serializable
{
	 ...
	 * @param id
	 */
	public SequencePk(final long id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof SequencePk)) {
			return false;
		}
		
		final SequencePk _cast = (SequencePk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.baobab.htc.data.daos.dto.SequencePk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
