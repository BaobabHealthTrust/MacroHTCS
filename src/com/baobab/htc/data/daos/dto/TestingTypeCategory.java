...
public class TestingTypeCategory implements Serializable
{
	/** 
	 * This attribute maps to the column testingTypeCategoryId in the TestingTypeCategory table.
	 */
	protected long testingTypeCategoryId;

	/** 
	 * This attribute maps to the column description in the TestingTypeCategory table.
	 */
	protected String description;

	/** 
	 * This attribute maps to the column dateCreated in the TestingTypeCategory table.
	 */
	protected Date dateCreated;

	/** 
	 * This attribute maps to the column createdBy in the TestingTypeCategory table.
	 */
	protected String createdBy;

	/** 
	 * This attribute maps to the column dateModified in the TestingTypeCategory table.
	 */
	protected Date dateModified;

	/** 
	 * This attribute maps to the column modifiedBy in the TestingTypeCategory table.
	 */
	protected String modifiedBy;

	/** 
	 * This attribute maps to the column status in the TestingTypeCategory table.
	 */
	...
	/**
	 * Method 'TestingTypeCategory'
	 * 
	 */
	public TestingTypeCategory()
	{
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof TestingTypeCategory)) {
			return false;
		}
		
		final TestingTypeCategory _cast = (TestingTypeCategory) _other;
	 ...
	 */
	public TestingTypeCategoryPk createPk()
	{
		return new TestingTypeCategoryPk(testingTypeCategoryId);
	}
	...
	public String toString()
	{
		...
		ret.append( "com.baobab.htc.data.daos.dto.TestingTypeCategory: " );
